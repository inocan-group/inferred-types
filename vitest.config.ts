...
export default defineConfig({
    resolve: {
        alias: {
            ...
            "transpiled/runtime": join(root, "/modules/runtime/dist/index.mjs"),
            "transpiled/types": join(root, "/modules/types/dist/index.mjs"),
            "transpiled/constants": join(root, "/modules/constants/dist/index.mjs"),
            "transpiled": join(root, "/modules/inferred-types/dist/index.mjs"),
        },
