import type { AfterFirst, AnyObject, First, Keys, Narrowable, Nothing, Tuple, TupleToUnion, UnionToTuple, WithoutValue } from "inferred-types/types";
 ...
 * as input.
 */
export interface ConverterDefn<
    TStr,
    TNum,
    TBool,
    TObj,
