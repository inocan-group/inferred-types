import type { CssAbsolutionPositioningProperties, CssAlignProperties, CssAnimationProperties, CssAppearance, CssAspectRatio, CssBackdropFilter, CssBackgroundProperties, CssBorderProperties, CssBoxProperties, CssBreakProperties, CssColor, CssColorLight, CssContent, CssCursor, CssDisplay, CssFlex, CssFlexBasis, CssFlexDirection, CssFlexFlow, CssFlexGrow, CssFlexShrink, CssFloat, CssFontProperties, CssGap, CssGlobal, CssHangingPunctuation, CssImageOrientation, CssImageRendering, CssImageResolution, CssJustifyProperties, CssLetterSpacing, CssListStyle, CssMarginProperties, CssMixBlendMode, CssObjectFit, CssObjectPosition, CssOffsetProperties, CssOpacity, CssOutlineProperties, CssOverflowProperties, CssPaddingProperties, CssPerspectiveOrigin, CssPlaceProperties, CssPosition, CssRotation, CssSizing, CssSizingLight, CssStrokeProperties, CssTextProperties, CssTransformProperties, CssTranslate, CssWhiteSpace, CssWhiteSpaceCollapse, CssWordBreak, CssWritingMode, Suggest } from "inferred-types/types";
