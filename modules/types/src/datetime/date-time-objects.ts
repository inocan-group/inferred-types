...
export interface MomentJs {
     ...
     */
    set: ((config: object) => void) & ((unit: string, value: number) => MomentJs);
     ...
     */
    months: (() => string[]) & ((m: MomentJs, format?: string) => string);

    /**
     * Gets an array of all short month names.
     */
    monthsShort: (() => string[]) & ((m: MomentJs, format?: string) => string);
     ...
     */
    weekdays: (() => string[]) & ((m: MomentJs, format?: string) => string);

    /**
     * Gets an array of all short weekday names.
     */
    weekdaysShort: (() => string[]) & ((m: MomentJs) => string);

    /**
     * Gets an array of all minimum weekday names (e.g., "Mo", "Tu").
     */
    weekdaysMin: (() => string[]) & ((m: MomentJs) => string);
    ...
    calendar: ((key?: CalendarKey, m?: MomentJs, now?: MomentJs) => string) & (() => string) & ((referenceDay: MomentJs) => string) & ((referenceDay: MomentJs, formats: object) => string);

    fromNow: ((withoutSuffix?: boolean) => string) & ((withoutSuffix?: boolean) => string);
    from: ((moment: MomentJs, withoutSuffix?: boolean) => string) & ((moment: MomentJs | string | number | Date | string[], withoutSuffix?: boolean) => string);
    toNow: ((withoutSuffix?: boolean) => string) & ((withoutSuffix?: boolean) => string);
    to: ((moment: MomentJs, withoutSuffix?: boolean) => string) & ((moment: MomentJs | string | number | Date | string[], withoutSuffix?: boolean) => string);
    [key: string]: any;
}
