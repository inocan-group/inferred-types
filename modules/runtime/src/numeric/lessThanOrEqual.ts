import type { LessThanOrEqual } from "inferred-types/types";
 ...
 */
export function lessThanOrEqual<T extends number>(comparator: T): <TVal extends number>(val: TVal) => LessThanOrEqual<TVal, T> {
