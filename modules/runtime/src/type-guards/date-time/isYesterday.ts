import { getYesterday, isDate, isIsoExplicitDate, isLuxonDateTime, isMoment, isString, stripAfter } from "inferred-types/runtime";
 ...
 */
export function isYesterday(test: unknown): boolean {
  if (isString(test)) {
