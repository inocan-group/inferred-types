...
describe("ReplaceType<TContent,TFind,TReplace>", () => {
    ...
    it("numeric literal to string literal", () => {
        ...
        type cases = [Expect<Test<T1, "equals", "foo">>];
    });
    ...
    it("string to null", () => {
        ...
        type cases = [Expect<Test<T1, "equals", null>>];
    });
    ...
    it("null to number", () => {
        ...
        type cases = [Expect<Test<T1, "equals", number>>];
    });
    ...
    it("undefined to number literal", () => {
        ...
        type cases = [Expect<Test<T1, "equals", 42>>];
    });

    it("Unset to undefined", () => {
        type T1 = ReplaceType<Unset, Unset, undefined>;

        type cases = [Expect<Test<T1, "equals", undefined>>];
    });
