...
import { AssertSameValues } from "transpiled";
...
describe("UnionToTuple<U>", () => {
    ...
    it("tuple literals elements", () => {
        ...
        type cases = [Expect<AssertSameValues<T2, [[1, 2, 3], [4, 5, 6]]>>];
    });
    ...
    it("readonly tuple literals", () => {
        ...
        type cases = [
            Expect<
                AssertSameValues<T1, [readonly [1, 2, 3], readonly [4, 5, 6]]>
            >,
        ];
    });
...
describe("UnionToTuple__PreserveBoolean<T>", () => {
    ...
    it("readonly modifier is preserved", () => {
        ...
        type cases = [
            ...
            >,
            Expect<
                AssertSameValues<T2, [readonly [1, 2, 3], readonly string[]]>
            >,
        ];
    });
});
