...
describe("Github types and type guards", () => {
    it("GithubRepoUrl<T> and isGithubRepoUrl()", () => {
        ...
        const repoWide =
            "https://github.com/inocan-group/inferred-types" as string;

        expect(isGithubRepoUrl(repo)).toEqual(true);

        if (isGithubRepoUrl(repo)) {
            type cases1 = [Expect<Test<typeof repo, "equals", typeof repo>>];
        }
        ...
        if (isGithubRepoUrl(bad)) {
            type cases1 = [Expect<Test<typeof bad, "equals", never>>];
        }

        type cases = [ExpectTrue<T1>, ExpectFalse<F1>];
    });

    it("GithubIssuesUrl, GithubIssueUrl, and type guards ", () => {
        const validIssueList =
            "https://github.com/inocan-group/inferred-types/issues";
        const validIssue =
            "https://github.com/inocan-group/inferred-types/issues/001";
        const validIssueWithQuery =
            "https://github.com/inocan-group/inferred-types/issues/001?foo=bar";
        ...
        type cases = [
            Expect<
                Test<typeof validIssueList, "extends", GithubRepoIssuesListUrl>
            >,
            Expect<Test<typeof validIssue, "extends", GithubRepoIssueUrl>>,
            Expect<
                Test<typeof validIssueWithQuery, "extends", GithubRepoIssueUrl>
            >,

            Expect<
                Test<typeof malformedIssue, "doesNotExtend", GithubRepoIssueUrl>
            >,
        ];
    });
    ...
    it("GithubProjectsUrl, GithubProjectUrl, and type guards ", () => {
        const validProjectList =
            "https://github.com/inocan-group/inferred-types/projects";
        const validProject =
            "https://github.com/inocan-group/inferred-types/projects/001";
        const validProjectWithQuery =
            "https://github.com/inocan-group/inferred-types/projects/001?foo=bar";
        ...
        type cases = [
            Expect<
                Test<typeof validProjectList, "extends", GithubRepoProjectsUrl>
            >,
            Expect<Test<typeof validProject, "extends", GithubRepoProjectUrl>>,
            Expect<
                Test<
                    typeof validProjectWithQuery,
                    "extends",
                    GithubRepoProjectUrl
                >
            >,
    ...
    it("GithubReleasesUrl, GithubReleaseUrl, and type guards ", () => {
        const validReleaseList =
            "https://github.com/inocan-group/inferred-types/releases";
        const validRelease =
            "https://github.com/inocan-group/inferred-types/releases/tag/v0.0.0";
        const validReleaseWithQuery =
            "https://github.com/inocan-group/inferred-types/releases/tag/v.0.0.0?foo=bar";
        ...
        type T3 = Extends<
            typeof validReleaseWithQuery,
            GithubRepoReleaseTagUrl
        >;

        type F1 = DoesNotExtend<typeof malformedList, GithubRepoReleasesUrl>;
        type F2 = DoesNotExtend<
            typeof malformedRelease,
            GithubRepoReleaseTagUrl
        >;
        ...
        type cases = [
            Expect<
                Test<typeof validReleaseList, "extends", GithubRepoReleasesUrl>
            >,
            Expect<
                Test<typeof validRelease, "extends", GithubRepoReleaseTagUrl>
            >,
            Expect<
                Test<
                    typeof validReleaseWithQuery,
