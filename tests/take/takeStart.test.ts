...
describe("TakeStart<TMatch, TContent>", () => {
    ...
    it("with callback", () => {
        type Cb = <M extends string, S extends TakeState>(
            val: M,
            state: S,
        ) => UpdateTake<S, M, Capitalize<M>>;
...
describe("takeStart(...matches)(content)", () => {
    describe("default variant", () => {
        it("happy path", () => {
            ...
            type cases = [
                Expect<
                    Test<typeof partial, "equals", TakeStartFn<["foo", "bar"]>>
                >,

                Expect<Test<typeof take1, "extends", TakeState>>,
                Expect<Test<(typeof take1)["parsed"], "equals", ["foo"]>>,
                Expect<
                    Test<(typeof take2)["parsed"], "equals", ["foo", "bar"]>
                >,
                Expect<
                    Test<(typeof take2)["parseString"], "equals", " forever">
                >,
            ];
        });
    });
