...
describe("keysOf(obj)", () => {
    it("happy path", () => {
        ...
        type cases = [Expect<Test<typeof t1, "equals", ["foo", "bar"]>>];
    });
    ...
    it("empty object", () => {
        ...
        type cases = [Expect<Test<typeof t1, "equals", []>>];
    });
    ...
    it("deeply nested", () => {
        ...
        type cases = [Expect<Test<typeof t1, "equals", ["foo"]>>];
    });
    ...
    it("wide object", () => {
        ...
        type cases = [Expect<Test<typeof t1, "equals", ObjectKey[]>>];
    });
});
