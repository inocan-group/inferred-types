...
describe("Narrowable", () => {
    ...
    it("narrow() runtime util", () => {
        ...
        type cases = [
            ...
            Expect<Test<typeof stringTuple3, "equals", ["foo", "bar"]>>,
            Expect<Test<typeof stringTuple4, "equals", ["foo", "bar"]>>,

            Expect<Test<typeof mixedTuple1, "equals", ["foo", 42]>>,
            Expect<Test<typeof mixedTuple2, "equals", ["foo", 42]>>,
