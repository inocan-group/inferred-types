import { Equal, ExpectTrue, ExpectFalse } from "@type-challenges/utils";
import { describe, it } from "vitest";

import { IsLiteral, IfLiteral, EmptyObject, IndexableObject, IsObjectLiteral, RemoveIndexKeys } from "../../src/types/base";
