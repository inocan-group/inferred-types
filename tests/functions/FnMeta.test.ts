...
describe("FnMeta<T>", () => {
    it("identity function", () => {
        ...
        type F = Identity["fn"];
        type R = Identity["returns"];

        type cases = [
            Expect<Test<F, "equals", () => "hi">>,
    ...
    it("static function with parameters", () => {
        type T = FnMeta<
            (
                name: string,
                age: number,
            ) => `Hi ${typeof name}, you are ${typeof age} years old`
        >;
    ...
    it("narrowing function with params", () => {
        type T1 = FnMeta<
            <TName extends string, TAge extends number>(
                name: TName,
                age: TAge,
            ) => `Hi ${typeof name}, you are ${typeof age} years old`
        >;
        type T2 = FnMeta<
            <TName extends string, TAge extends number>(
                name: TName,
                age: TAge,
            ) => `Hi ${TName}, you are ${TAge} years old`
        >;
        ...
        type cases = [
            Expect<
                Test<
                    ...
                    "equals",
                    {
                        fn: <TName extends string, TAge extends number>(
                            name: TName,
                            age: TAge,
                        ) => `Hi ${typeof name}, you are ${typeof age} years old`;
                        params: [name: string, age: number];
    ...
    it("TArgs (not readonly)", () => {
        type T1 = FnMeta<
            <TArgs extends [string, number]>(
                ...args: TArgs
            ) => `Hi ${TArgs[0]}, you are ${TArgs[1]} years old`
        >;
        ...
        type cases = [
            Expect<
                Test<
                    ...
                    "equals",
                    {
                        fn: <TArgs extends [string, number]>(
                            ...args: TArgs
                        ) => `Hi ${TArgs[0]}, you are ${TArgs[1]} years old`;
        ...
        type cases = [
            Expect<
                Test<
                    ...
                    "equals",
                    {
                        fn: <TArgs extends readonly [string, number]>(
                            ...args: TArgs
                        ) => `Hi ${TArgs[0]}, you are ${TArgs[1]} years old`;
                        params: [string, number];
                        returns: `Hi ${string}, you are ${number} years old`;
