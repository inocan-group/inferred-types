...
import type { Expect, IsBefore, Test } from "inferred-types/types";
    ...
    describe("ISO Date Comparisons", () => {
        it("returns true when first date is before second date", () => {
            ...
            type cases = [
                Expect<Test<T1, "equals", true>>,
                Expect<
                    Test<IsBefore<"2023-01-01", "2023-01-02">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2022-12-31", "2023-01-01">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2023-05-15", "2023-05-16">, "equals", true>
                >,
            ];
        });
        ...
        it("returns false when first date is after second date", () => {
            type cases = [
                Expect<
                    Test<IsBefore<"2023-12-31", "2023-01-01">, "equals", false>
                >,
                Expect<
                    Test<IsBefore<"2023-01-02", "2023-01-01">, "equals", false>
                >,
                Expect<
                    Test<IsBefore<"2023-01-01", "2022-12-31">, "equals", false>
                >,
                Expect<
                    Test<IsBefore<"2023-05-16", "2023-05-15">, "equals", false>
                >,
            ];
        });
        ...
        it("returns false when dates are equal", () => {
            type cases = [
                Expect<
                    Test<IsBefore<"2023-01-01", "2023-01-01">, "equals", false>
                >,
                Expect<
                    Test<IsBefore<"2023-12-31", "2023-12-31">, "equals", false>
                >,
                Expect<
                    Test<IsBefore<"2023-06-15", "2023-06-15">, "equals", false>
                >,
            ];
        });
    });
    ...
    describe("Wide Type Handling", () => {
        it("returns boolean for wide DateLike types", () => {
            type cases = [
                ...
                Expect<
                    Test<IsBefore<`${number}`, `${number}`>, "equals", boolean>
                >,
            ];
        });
    });
    ...
    describe("Advanced ISO Format Tests", () => {
        ...
        it("handles month and day boundaries correctly", () => {
            type cases = [
                ...
                Expect<
                    Test<IsBefore<"2023-01-31", "2023-02-01">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2023-02-01", "2023-01-31">, "equals", false>
                >,
                // February boundary (non-leap year)
                Expect<
                    Test<IsBefore<"2023-02-28", "2023-03-01">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2023-03-01", "2023-02-28">, "equals", false>
                >,
                // February boundary (leap year)
                Expect<
                    Test<IsBefore<"2024-02-28", "2024-02-29">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2024-02-29", "2024-03-01">, "equals", true>
                >,
            ];
        });
    });
    ...
    describe("Edge Cases", () => {
        it("handles boundary dates correctly", () => {
            type cases = [
                // Leap year boundary
                Expect<
                    Test<IsBefore<"2020-02-28", "2020-02-29">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2020-02-29", "2020-03-01">, "equals", true>
                >,
                // Year boundaries
                Expect<
                    Test<IsBefore<"1999-12-31", "2000-01-01">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2000-01-01", "1999-12-31">, "equals", false>
                >,
                // Month boundaries
                Expect<
                    Test<IsBefore<"2023-01-31", "2023-02-01">, "equals", true>
    ...
    describe("Multiple Same Type Comparisons", () => {
        ...
        it("works with multiple date comparisons in sequence", () => {
            type cases = [
                ...
                >,
                Expect<
                    Test<IsBefore<"2023-01-02", "2023-01-03">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2023-01-01", "2023-01-03">, "equals", true>
                >,
                Expect<
                    Test<IsBefore<"2023-01-03", "2023-01-01">, "equals", false>
                >,
            ];
        });
