...
const opLetter = createTypeMapRule("equals", "<letter>", ["As", "<letter>" as `${Alpha}`]);
const opLetterLower = createTypeMapRule("equals", "<letter:lowercase>", ["As", "0" as `${LowerAlpha}`]);
const opLetterUpper = createTypeMapRule("equals", "<letter:uppercase>", ["As", "0" as `${UpperAlpha}`]);
