 ...
 * - with the generic you can specify a particular formulation of props and return type
 */
export type FunctionType<T extends Function = Function> = T | (T & { [key: string]: any });
